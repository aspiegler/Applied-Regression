---
title: "Solutions Module 1: Foundations of R"
author: 
  - name: "Adam Spiegler"
...
- [Chapter 1 R Foundations](https://jfrench.github.io/LinearRegression/r-foundations.html) from A Progressive Introduction to Linear Models
- See [Appendix A: Getting Started with RStudio](https://aspiegler.github.io/Applied-Regression/Appendix/A-Getting-Started-with-Rstudio.html) for more background information about R, RStudio, Quarto, and Markdown.
...
Edit YAML at start of document accordingly. Answers will vary.
