...
What would the outputs of the commands `is.list(x4)` and `is.vector(x4)` be? Without running the commands, enter your answer in the text cell below. Then check your answers by running the code cell below the solution text cell.
